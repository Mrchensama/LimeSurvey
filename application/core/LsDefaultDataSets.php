...
class LsDefaultDataSets
{
    ...
    public static function getSurveyMenuEntryData()
    {
        ...
        $basicMenues = [
            ...
            [2, null, 5, 'participants', gT('Survey participants', 'unescaped'), gT('Survey participants', 'unescaped'), gT('Go to survey participant and token settings', 'unescaped'), 'user', 'fontawesome', '', 'admin/tokens/sa/index/', '', '', '', '', 'tokens', 'update', '{"render": { "link": {"data": {"surveyid": ["survey","sid"]}}}}', '', 'en-GB', 1, date('Y-m-d H:i:s'), 0, date('Y-m-d H:i:s'), 0, 1],
    ...
    /**
     * Default user administration global configuration
     * This function 
     * @return array with user administration default setting
     */
    public static function getDefaultUserAdministrationSetting()
    {
        $default =  [];
